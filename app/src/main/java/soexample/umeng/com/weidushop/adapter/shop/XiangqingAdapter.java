package soexample.umeng.com.weidushop.adapter.shop;
...
public class XiangqingAdapter extends RecyclerView.Adapter<XiangqingAdapter.ViewHolder> {
    ...
    private ShopXiangBean.ResultBean list;

    public XiangqingAdapter(Context context,ShopXiangBean.ResultBean list) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = View.inflate(context, R.layout.item_xiang, null);
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        holder.vpImg.setOnClickListener(new View.OnClickListener() {
            @Override
