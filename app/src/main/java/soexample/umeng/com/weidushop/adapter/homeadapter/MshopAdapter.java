 ...
 * function:
 */
public class MshopAdapter extends RecyclerView.Adapter<MshopAdapter.ViewHodler> {
    private Context context;
    private List<ShowBean.ResultBean.MlssBean.CommodityListBeanXX> list;

    public MshopAdapter(Context context, List<ShowBean.ResultBean.MlssBean.CommodityListBeanXX> list) {
    ...
    public ViewHodler onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view=View.inflate(context,R.layout.item_ml,null);
