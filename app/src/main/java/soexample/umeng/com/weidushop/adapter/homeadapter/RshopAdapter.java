 ...
 * function:
 */
public class RshopAdapter extends RecyclerView.Adapter<RshopAdapter.ViewHodler> {
    private Context context;
    private List<ShowBean.ResultBean.RxxpBean.CommodityListBean> list;

    public RshopAdapter(Context context, List<ShowBean.ResultBean.RxxpBean.CommodityListBean> list) {
    ...
    public ViewHodler onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view=View.inflate(context,R.layout.item_rx,null);
